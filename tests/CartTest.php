...
use Boolfalse\LaravelShoppingCart\CartItem;
use Illuminate\Support\Facades\Event;
use Illuminate\Session\SessionManager;
use Illuminate\Contracts\Auth\Authenticatable;
use Boolfalse\LaravelShoppingCart\LSCServiceProvider;
use Boolfalse\Tests\Shoppingcart\Fixtures\ProductModel;
use Boolfalse\Tests\Shoppingcart\Fixtures\BuyableProduct;
...
class CartTest extends TestCase
{
    ...
    {
        return [LSCServiceProvider::class];
    }
    ...
    /**
     * @test
     * @expectedException \Boolfalse\LaravelShoppingCart\Exceptions\InvalidRowIDException
     */
    ...
    /**
     * @test
     * @expectedException \Boolfalse\LaravelShoppingCart\Exceptions\UnknownModelException
     ...
     *
     * @return \Boolfalse\LaravelShoppingCart\Cart
     */
